...
export const AyahView: React.FC<AyahViewProps> = memo(({ 
  ...
  const prevIsAutoplaying = useRef(false); 
  ...
  useEffect(() => {
    if (isAutoplaying && !prevIsAutoplaying.current) {
      setIsJustActivated(true);
      const timer = setTimeout(() => setIsJustActivated(false), 800); // Animation duration
      return () => clearTimeout(timer);
    }
    prevIsAutoplaying.current = isAutoplaying;
  }, [isAutoplaying]);
  ...
  return (
    <div 
        ...
        className={cn(
            ...
            (isActive || isAutoplaying)
                ? 'bg-yellow-50 dark:bg-yellow-900/40 border-l-4 border-yellow-500 py-4 pl-3 pr-4'
                : 'p-4',
            isAutoplaying && 'animate-glow-border',
            isJustActivated && 'animate-highlight-flash'
        )}
    >
      ...
      <div className="space-y-3 mt-4 text-left">
       ...
       <div className="mt-4 flex items-center gap-2 flex-wrap">
        ...
        <div className={cn(
         ...
         <Card className="bg-blue-50 dark:bg-blue-900/40 border-blue-200 dark:border-blue-800">
            <CardContent className="p-4">
                {isLoadingQuickTafsir ? (
                    ...
                    <>
                        <h4 className="font-bold text-blue-800 dark:text-blue-300">Tafsiran Cepat (JAKIM)</h4>
