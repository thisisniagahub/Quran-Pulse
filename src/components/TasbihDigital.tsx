        ...
        <div className="max-w-md mx-auto text-center">
            ...
            <Card className="mb-6 overflow-hidden">
                <CardContent className="p-6">
                    <div 
                        className="relative w-64 h-64 mx-auto rounded-full flex items-center justify-center cursor-pointer select-none bg-background overflow-hidden"
                    ...
                    >
                        ...
                        <svg className="absolute w-full h-full" viewBox="0 0 100 100">
                            <circle className="text-border" strokeWidth="5" stroke="currentColor" fill="transparent" r="45" cx="50" cy="50" />
                            <circle
                ...
                <div className="flex flex-wrap justify-center gap-3">
                    {presets.map(p => (
                        <button 
                            ...
                            className={`px-4 py-2 rounded-full font-semibold transition-colors ${activePreset === p.label ? 'bg-primary text-white' : 'bg-card hover:bg-primary/10'}`}
                        >
                            {p.label}
                        </button>
                    ))}
