...
const LearningPath: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 dark:from-background-dark dark:to-card-dark">
      {/* Header Stats */}
      <div className="bg-card-light dark:bg-card-dark shadow-sm border-b border-border-light dark:border-border-dark sticky top-0 z-10">
        ...
        <div className="space-y-12">
          {units.map((unit) => (
            <div key={unit.id} className="relative">
              {/* Unit Header */}
              <div className={`${unit.color} rounded-2xl p-6 shadow-lg ${!unit.isUnlocked && 'opacity-50'}`}>
              ...
              <div className="relative mt-6 space-y-6">
                ...
                {unit.lessons.map((lesson, lessonIndex) => (
                  ...
                  >
                    ...
                    >
                      <div className="bg-card-light dark:bg-card-dark rounded-2xl shadow-md p-4 border-2 border-border-light dark:border-border-dark hover:border-primary/50">
                    ...
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                      ...
                      } border-4 border-card-light dark:border-card-dark shadow-md`} />
                    </div>
                  </div>
                ))}
              </div>
