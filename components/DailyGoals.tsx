...
const DailyGoals: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      {/* Header */}
      <div className="bg-card-light dark:bg-card-dark rounded-2xl shadow-sm p-6">
        ...
        <div className="bg-background-light dark:bg-background-dark rounded-xl p-4">
          ...
          <div className="relative h-4 bg-foreground-light/10 dark:bg-foreground-dark/10 rounded-full overflow-hidden">
            <div
            ...
            <div
              ...
              className={`border-2 rounded-xl p-4 transition-all ${
                goal.completed 
                  ...
                  : 'bg-background-light dark:bg-background-dark border-border-light dark:border-border-dark hover:border-border-light/50 dark:hover:border-border-dark/50'
              }`}
            >
              <div className="flex items-center gap-4">
                <div className={`p-3 rounded-xl ${goal.completed ? 'bg-green-100 dark:bg-green-500/20' : 'bg-foreground-light/5 dark:bg-foreground-dark/5'}`}>
                  {goal.completed ? (
                ...
                <div className="text-right">
                  ...
                  {!goal.completed && (
                    <div className="w-24 h-2 bg-foreground-light/10 dark:bg-foreground-dark/10 rounded-full mt-2">
                      <div
      ...
      <div className="bg-card-light dark:bg-card-dark rounded-2xl shadow-sm p-6">
        ...
        <div className="space-y-4">
          {challenges.map(challenge => (
            <div
              key={challenge.id}
              className="border-2 border-border-light dark:border-border-dark rounded-xl p-5 hover:border-border-light/50 dark:hover:border-border-dark/50 transition-all hover:shadow-md"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="mb-3">
                    ...
                    <div className="h-3 bg-foreground-light/10 dark:bg-foreground-dark/10 rounded-full overflow-hidden">
                      <div
      ...
      <div className="bg-card-light dark:bg-card-dark rounded-2xl shadow-sm p-6">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <button
            ...
            className="px-4 py-2 bg-background-light dark:bg-background-dark rounded-lg font-bold hover:bg-background-light/80 dark:hover:bg-background-dark/80"
          >
            -
          </button>
