// --- P2 REFACTOR: CENTRALIZED AUDIO UTILITIES ---
// This file now contains all shared audio processing functions to avoid code duplication
// across components like LiveConversation and TajweedCoach.
...
// Raw PCM to AudioBuffer conversion for Web Audio API
...
// Helper to create a Blob object for the Live API
